...
// Recuperar datos si hubo errores al enviar
...
<main class="container">
  ...
  <?php if ($flashes): ?>
    <div class="card" role="status" aria-atomic="true">
  ...
  <form action="<?= htmlspecialchars(app_url('/back/controllers/expenses_update.php')) ?>" method="post" class="card" novalidate>
    <?= csrf_field() ?>
    ...
    <div class="field actions">
      ...
      <a class="btn" href="<?= htmlspecialchars(app_url('/front/index.php')) ?>">Cancelar</a>
    </div>
  </form>
